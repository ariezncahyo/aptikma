<script>
	...
	json_label_homepage = <?php echo json_encode($label_homepage) ?>;

	function load_label_homepage(label_homepage){
		var html="";
...
load_label_homepage(json_label_homepage);
			...
			success: function (data, textStatus, jqXHR) {
                ...
                $("#load_form_modal").fadeOut(1000, function (){
                    ...
                    $("#notif_form_modal").fadeOut(2000, function (){
                        json_label_homepage=data.label_homepage;
                        load_label_homepage(json_label_homepage);
                        $("#id_modal").modal("hide");
                    });
                });
...
function showDelete(i){
	$("#hapus_id_label_homepage").val(json_label_homepage[i].id_label_homepage);
	$("#hapus_nama_label_homepage").html(json_label_homepage[i].label_en);
...
$("#form_model_del").submit(function (e){
        ...
        $.ajax({
            url: "<?php echo base_url().'admin/mst_label_homepage/delete_label'; ?>",
            data: {"id_label_homepage":$("#hapus_id_label_homepage").val()},
            type: 'POST',
            dataType: 'json',
            success: function (data, textStatus, jqXHR) {
