<script>
	json_label = <?php echo json_encode($label_portfolio) ?>;
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Data Label Portfolio</h4>
            </div>
            ...
            <div class="modal-body">
                <div class="box-body">
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="hidden" class="form-control" id="id_label_portfolio">
                    ...
                    <div class="form-group">
                        <label for="inputEmail3" class="col-sm-4 control-label">Posisi Label</label>
                        <div class="col-sm-8">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="box-body">
                    <center>
                        <input type="hidden" id="id_label_portfolio">
                        <p style="font-size: 15px;">Yakin Menghapus <span id="hapus_label_p" style="font-weight: bold;"></span> ?</p>
                    </center>
                </div>
            </div>
            <div class="modal-footer">
...
<script>
	...
	function showEdit(i){
		$("#id_label_portfolio").val(json_label[i].id_label_portfolio);
	...
	$("#form_model").submit(function (e){
		...
		$.ajax({
			url : "<?php echo base_url().'admin/mst_label_portfolio/insert_label_portfolio'; ?>",
			data : { "id_label_portfolio":$("#id_label_portfolio").val(),
			...
			success: function (data, textStatus, jqXHR) {
                ...
                $("#load_form_modal").fadeOut(1000, function (){
                    ...
                    $("#notif_form_modal").fadeOut(2000, function (){
                        json_label=data.label_portfolio;
                        load_label(json_label);
                        $("#id_modal").modal("hide");
                    });
                });
	...
	$("#form_model_del").submit(function (e){
        ...
        $.ajax({
            url: "<?php echo base_url().'admin/mst_label_portfolio/delete_label_portfolio'; ?>",
            data: {"id_label_portfolio":$("#id_label_portfolio").val()},
            type: 'POST',
            dataType: 'json',
            success: function (data, textStatus, jqXHR) {
