<script>
	...
	json_whychoose_homepage = <?php echo json_encode($whychoose_homepage) ?>;

	function load_whychoose_homepage(whychoose_homepage){
		var html="";
		for(var i = 0; i < whychoose_homepage.length; i++){
			var a = '<tr>\n\
						<td>'+(i+1)+'</td>\n\
                        <td>'+whychoose_homepage[i].title_en+'</td>\n\
                        <td>'+whychoose_homepage[i].title_id+'</td>\n\
                        <td>'+whychoose_homepage[i].desc_en+'</td>\n\
                        <td>'+whychoose_homepage[i].desc_id+'</td>\n\
                        <td>'+whychoose_homepage[i].image+'</td>\n\
						<td>\n\
            ...
            <div class="modal-body">
                <div class="box-body">
                    <div class="form-group">
                        <label for="inputEmail3" class="col-sm-4 control-label">Why Choose Title (English)</label>
                        <div class="col-sm-8">
                            <input type="hidden" class="form-control" id="id_whychoose_homepage">
                            <input type="text" class="form-control" id="title_en" required>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="inputEmail3" class="col-sm-4 control-label">Why Choose Title (Indonesia) </label>
                        <div class="col-sm-8">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="box-body">
                    <center>
                        <input type="hidden" id="hapus_id_whychoose_homepage">
                        <p style="font-size: 15px;">Do you really want to delete <span id="hapus_title_whychoose_homepage" style="font-weight: bold;"></span> ?</p>
                    </center>
                </div>
            </div>
            <div class="modal-footer">
    ...
    <div class="col-xs-12">
      <div class="box">
        <div class="box-header">
            <h3 class="box-title">Data Why Choose Homepage</h3>
...
load_whychoose_homepage(json_whychoose_homepage);

function showAdd(){
	$("#id_modal").modal("show");
	$("#id_whychoose_homepage").val("");
    $("#title_en").val("");
    $("#title_id").val("");
    $("#desc_en").val("");
    $("#desc_id").val("");
...
function showEdit(i){
	$("#id_whychoose_homepage").val(json_whychoose_homepage[i].id_whychoose_homepage);
    $("#title_en").val(json_whychoose_homepage[i].title_en);
    $("#title_id").val(json_whychoose_homepage[i].title_id);
    $("#desc_en").val(json_whychoose_homepage[i].desc_en);
    $("#desc_id").val(json_whychoose_homepage[i].desc_id);
    $("#image").val(json_whychoose_homepage[i].image);
	$("#id_modal").modal("show");	
}
...
$("#form_model").submit(function (e){
		...
		$.ajax({
			url: "<?php echo base_url().'admin/mst_whychoose_homepage/insert_whychoose_homepage'; ?>",
			data: { "id_whychoose_homepage":$("#id_whychoose_homepage").val(),
			...
			success: function (data, textStatus, jqXHR) {
                ...
                $("#load_form_modal").fadeOut(1000, function (){
                    ...
                    $("#notif_form_modal").fadeOut(2000, function (){
                        json_whychoose_homepage=data.whychoose_homepage;
                        load_whychoose_homepage(json_whychoose_homepage);
                        $("#id_modal").modal("hide");
                    });
                });
...
function showDelete(i){
	$("#hapus_id_whychoose_homepage").val(json_whychoose_homepage[i].id_whychoose_homepage);
	$("#hapus_title_whychoose_homepage").html(json_whychoose_homepage[i].title_en);
...
$("#form_model_del").submit(function (e){
        ...
        $.ajax({
            url: "<?php echo base_url().'admin/mst_whychoose_homepage/delete_whychoose_homepage'; ?>",
            data: {"id_whychoose_homepage":$("#hapus_id_whychoose_homepage").val()},
            type: 'POST',
            dataType: 'json',
            success: function (data, textStatus, jqXHR) {
