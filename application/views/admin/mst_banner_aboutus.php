<script>
	...
	json_banner_aboutus = <?php echo json_encode($banner_aboutus) ?>;

	function load_banner_aboutus(banner_aboutus){
		var html="";
		for(var i = 0; i < banner_aboutus.length; i++){
			var a = '<tr>\n\
						<td>'+(i+1)+'</td>\n\
                        <td>'+banner_aboutus[i].image+'</td>\n\
						<td>\n\
            ...
            <div class="modal-body">
                <div class="box-body">
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="hidden" class="form-control" id="id_banner_aboutus">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="box-body">
                    <center>
                        <input type="hidden" id="hapus_id_banner_aboutus">
                        <p style="font-size: 15px;">Do you really want to delete it<span id="hapus_nama_banner_aboutus" style="font-weight: bold;"></span> ?</p>
                    </center>
                </div>
            </div>
            <div class="modal-footer">
    ...
    <div class="col-xs-12">
      <div class="box">
        <div class="box-header">
            <h3 class="box-title">Data Banner About Us</h3>
...
load_banner_aboutus(json_banner_aboutus);

function showAdd(){
	$("#id_modal").modal("show");
	$("#id_banner_aboutus").val("");
    $("#image").val("");
}

function showEdit(i){
	$("#id_banner_aboutus").val(json_banner_aboutus[i].id_banner_aboutus);
    $("#image").val(json_banner_aboutus[i].image);
	$("#id_modal").modal("show");	
}
...
$("#form_model").submit(function (e){
		...
		$.ajax({
			url: "<?php echo base_url().'admin/mst_banner_aboutus/insert_banner_aboutus'; ?>",
			data: { "id_banner_aboutus":$("#id_banner_aboutus").val(),
                    "image":$("#image").val()
				},
			type : 'POST',
			dataType : 'json',
			success: function (data, textStatus, jqXHR) {
                ...
                $("#load_form_modal").fadeOut(1000, function (){
                    ...
                    $("#notif_form_modal").fadeOut(2000, function (){
                        json_banner_aboutus=data.banner_aboutus;
                        load_banner_aboutus(json_banner_aboutus);
                        $("#id_modal").modal("hide");
                    });
                });
...
function showDelete(i){
	$("#hapus_id_banner_aboutus").val(json_banner_aboutus[i].id_banner_aboutus);
	$("#hapus_nama_banner_aboutus").html(json_banner_aboutus[i].name_en);
...
$("#form_model_del").submit(function (e){
        ...
        $.ajax({
            url: "<?php echo base_url().'admin/mst_banner_aboutus/delete_banner_aboutus'; ?>",
            data: {"id_banner_aboutus":$("#hapus_id_banner_aboutus").val()},
            type: 'POST',
            dataType: 'json',
            success: function (data, textStatus, jqXHR) {
