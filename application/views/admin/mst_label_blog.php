<script>
	...
	json_label_blog = <?php echo json_encode($label_blog) ?>;

	function load_label_blog(label_blog){
		var html="";
		for(var i = 0; i < label_blog.length; i++){
			var a = '<tr>\n\
						<td>'+(i+1)+'</td>\n\
                        <td>'+label_blog[i].position+'</td>\n\
						<td>'+label_blog[i].label_en+'</td>\n\
						<td>'+label_blog[i].label_id+'</td>\n\
						<td>\n\
            ...
            <div class="modal-body">
                <div class="box-body">
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="hidden" class="form-control" id="id_label_blog">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="box-body">
                    <center>
                        <input type="hidden" id="hapus_id_label_blog">
                        <p style="font-size: 15px;">YDo you really want to delete <span id="hapus_nama_label_blog" style="font-weight: bold;"></span> ?</p>
                    </center>
                </div>
            </div>
            <div class="modal-footer">
    ...
    <div class="col-xs-12">
      <div class="box">
        <div class="box-header">
            <h3 class="box-title">Data Label Blog</h3>
...
load_label_blog(json_label_blog);
...
function showEdit(i){
	$("#id_label_blog").val(json_label_blog[i].id_label_blog);
    $("#position").val(json_label_blog[i].position);    
	$("#label_en").val(json_label_blog[i].label_en);
	$("#label_id").val(json_label_blog[i].label_id);
	$("#id_modal").modal("show");	
}
...
$("#form_model").submit(function (e){
		...
		$.ajax({
			url: "<?php echo base_url().'admin/mst_label_blog/insert_label'; ?>",
			data: { "id_label_blog":$("#id_label_blog").val(),
			...
			success: function (data, textStatus, jqXHR) {
                ...
                $("#load_form_modal").fadeOut(1000, function (){
                    ...
                    $("#notif_form_modal").fadeOut(2000, function (){
                        json_label_blog=data.label_blog;
                        load_label_blog(json_label_blog);
                        $("#id_modal").modal("hide");
                    });
                });
...
function showDelete(i){
	$("#hapus_id_label_blog").val(json_label_blog[i].id_label_blog);
	$("#hapus_nama_label_blog").html(json_label_blog[i].label_en);
...
$("#form_model_del").submit(function (e){
        ...
        $.ajax({
            url: "<?php echo base_url().'admin/mst_label_blog/delete_label'; ?>",
            data: {"id_label_blog":$("#hapus_id_label_blog").val()},
            type: 'POST',
            dataType: 'json',
            success: function (data, textStatus, jqXHR) {
