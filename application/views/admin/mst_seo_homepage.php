    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Insert/Update SEO</h4>
            </div>
            ...
            <div class="modal-body">
                <div class="box-body">
                    <center>
                        ...
                        <p style="font-size: 15px;">Do you really want to delete <span id="hapus_meta_tag_seo_homepage" style="font-weight: bold;"></span> ?</p>
                    </center>
                </div>
            </div>
            <div class="modal-footer">
