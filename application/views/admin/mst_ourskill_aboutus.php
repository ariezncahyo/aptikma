<script>
	...
	json_ourskill_aboutus = <?php echo json_encode($ourskill_aboutus) ?>;

	function load_ourskill_aboutus(ourskill_aboutus){
		var html="";
		for(var i = 0; i < ourskill_aboutus.length; i++){
			var a = '<tr>\n\
						<td>'+(i+1)+'</td>\n\
						<td>'+ourskill_aboutus[i].title_en+'</td>\n\
						<td>'+ourskill_aboutus[i].title_id+'</td>\n\
                        <td>'+ourskill_aboutus[i].desc_en+'</td>\n\
                        <td>'+ourskill_aboutus[i].desc_id+'</td>\n\
						<td>\n\
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Insert/Update SKill</h4>
            </div>
            <form id="form_model" class="form-horizontal">
            <div class="modal-body">
                <div class="box-body">
                    <div class="form-group">
                        <label for="inputEmail3" class="col-sm-4 control-label">Skill Title (English)</label>
                        <div class="col-sm-8">
                            <input type="hidden" class="form-control" id="id_ourskill_aboutus">
                            <input type="text" class="form-control" id="title_en" required>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="inputEmail3" class="col-sm-4 control-label">Skill Title (Indonesia) </label>
                        <div class="col-sm-8">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="box-body">
                    <center>
                        <input type="hidden" id="hapus_id_ourskill_aboutus">
                        <p style="font-size: 15px;">Do you really want to delete <span id="hapus_title_ourskill_aboutus" style="font-weight: bold;"></span> ?</p>
                    </center>
                </div>
            </div>
            <div class="modal-footer">
    ...
    <div class="col-xs-12">
      <div class="box">
        <div class="box-header">
            <h3 class="box-title">Data Our SKills About Us</h3>
...
load_ourskill_aboutus(json_ourskill_aboutus);

function showAdd(){
	$("#id_modal").modal("show");
	$("#id_ourskill_aboutus").val("");
	$("#title_en").val("");
	$("#title_id").val("");
    $("#desc_en").val("");
    $("#desc_id").val("");
...
function showEdit(i){
	$("#id_ourskill_aboutus").val(json_ourskill_aboutus[i].id_ourskill_aboutus);
	$("#title_en").val(json_ourskill_aboutus[i].title_en);
	$("#title_id").val(json_ourskill_aboutus[i].title_id);
    $("#desc_en").val(json_ourskill_aboutus[i].desc_en);
    $("#desc_id").val(json_ourskill_aboutus[i].desc_id);
	$("#id_modal").modal("show");	
}
...
$("#form_model").submit(function (e){
		...
		$.ajax({
			url: "<?php echo base_url().'admin/mst_ourskill_aboutus/insert_ourskill_aboutus'; ?>",
			data: { "id_ourskill_aboutus":$("#id_ourskill_aboutus").val(),
			...
			success: function (data, textStatus, jqXHR) {
                ...
                $("#load_form_modal").fadeOut(1000, function (){
                    ...
                    $("#notif_form_modal").fadeOut(2000, function (){
                        json_ourskill_aboutus=data.ourskill_aboutus;
                        load_ourskill_aboutus(json_ourskill_aboutus);
                        $("#id_modal").modal("hide");
                    });
                });
...
function showDelete(i){
	$("#hapus_id_ourskill_aboutus").val(json_ourskill_aboutus[i].id_ourskill_aboutus);
	$("#hapus_title_ourskill_aboutus").html(json_ourskill_aboutus[i].title_en);
...
$("#form_model_del").submit(function (e){
        ...
        $.ajax({
            url: "<?php echo base_url().'admin/mst_ourskill_aboutus/delete_ourskill_aboutus'; ?>",
            data: {"id_ourskill_aboutus":$("#hapus_id_ourskill_aboutus").val()},
            type: 'POST',
            dataType: 'json',
            success: function (data, textStatus, jqXHR) {
